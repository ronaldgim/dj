...
urlpatterns = [
    ...
    path(
        route = 'reporte-error-lote-v2',
        view  = views.reporte_error_lote_v2,
        name  = 'reporte_error_lote_v2'
    ),
    
    path(
        route = 'reporte-error-lote-excel-v2',
        view  = views.reporte_error_lote_excel_v2,
        name  = 'reporte_error_lote_excel_v2'
    ),
